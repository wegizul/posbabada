                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="form">
                            ...
                            <?php echo admin_form_open('reports/tax', 'autocomplete="off"'); ?>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('biller', $bl, ($_POST['biller'] ?? ''), 'class="form-control" id="biller" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('biller') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="table-responsive">
                                    <table id="PTAXData" class="table table-bordered table-hover table-striped table-condensed reports-table">
                                        <thead>
                                            <tr>
                                                <th style="min-width:150px !important;"><?= lang('date'); ?></th>
                                                <th style="min-width:150px !important;"><?= lang('reference_no'); ?></th>
