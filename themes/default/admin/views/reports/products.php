                ...
                <div id="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf2', 'cf2') ?>
                                <?= form_input('cf2', ($_POST['cf2'] ?? ''), 'class="form-control tip" id="cf2"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf3', 'cf3') ?>
                                <?= form_input('cf3', ($_POST['cf3'] ?? ''), 'class="form-control tip" id="cf3"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf4', 'cf4') ?>
                                <?= form_input('cf4', ($_POST['cf4'] ?? ''), 'class="form-control tip" id="cf4"') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('pcf5', 'cf5') ?>
                                <?= form_input('cf5', ($_POST['cf5'] ?? ''), 'class="form-control tip" id="cf5"') ?>
                            </div>
                        </div>
