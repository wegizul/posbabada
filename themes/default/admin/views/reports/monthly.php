                    ...
                    <table class="table table-bordered table-striped dfTable reports-table">
                        <thead>
                            <tr class="year_roller">
                                <th><a class="white" href="<?= admin_url('reports/monthly_sales/' . (isset($warehouse_id) ? $warehouse_id : 0) . '/' . ($year - 1)); ?>">&lt;&lt;</a></th>
...
<script type="text/javascript">
    function cari_toko(toko) {
        window.location.href = '<?= admin_url('reports/monthly_sales'); ?>/' + toko + '/' + <?= $year ?>;
    }
    $(document).ready(function() {
        $('#pdf').click(function(event) {
            event.preventDefault();
            window.location.href = "<?= admin_url('reports/monthly_sales/' . ($warehouse_id ? $warehouse_id : 0) . '/' . $year . '/pdf') ?>";
            return false;
        });
