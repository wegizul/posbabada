                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="form">
                            ...
                            <?php echo admin_form_open('reports/supplier_report/' . $user_id, 'autocomplete="off"'); ?>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('warehouse', $wh, ($_POST['warehouse'] ?? ''), 'class="form-control" id="warehouse" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('warehouse') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="controls"> <?php echo form_submit('submit_purchase_report', $this->lang->line('submit'), 'class="btn btn-primary"'); ?> </div>
                            </div>
                            <?php echo form_close(); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="payform">
                            ...
                            <?php echo admin_form_open('reports/supplier_report/' . $user_id . '/#payments-con', 'autocomplete="off"'); ?>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('pay_user', $us, ($_POST['pay_user'] ?? ''), 'class="form-control" id="user" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('user') . '"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('start_date', 'start_date'); ?>
                                        <?php echo form_input('pay_start_date', ($_POST['pay_start_date'] ?? ''), 'class="form-control date" id="start_date"'); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?= lang('end_date', 'end_date'); ?>
                                        <?php echo form_input('pay_end_date', ($_POST['pay_end_date'] ?? ''), 'class="form-control date" id="end_date"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
