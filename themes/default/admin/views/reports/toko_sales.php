...
<script>
    $(document).ready(function() {
        function spt(x) {
            return '<div class="text-right">' + formatQuantity2(x) + '</div>';
        }
        oTable = $('#SlRData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= admin_url('reports/getSalesTokoReport/?v=1' . $v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i>Laporan Penjualan Pertoko <?php
                                                                                    if ($this->input->post('start_date')) {
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#pdf').click(function(event) {
            ...
            window.location.href = "<?= admin_url('reports/getSalesTokoReport/pdf/?v=1' . $v) ?>";
            return false;
        });
        $('#xls').click(function(event) {
            event.preventDefault();
            window.location.href = "<?= admin_url('reports/getSalesTokoReport/0/xls/?v=1' . $v) ?>";
            return false;
        });
