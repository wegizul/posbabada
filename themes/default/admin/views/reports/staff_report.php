        ...
        <div id="sales-con" class="tab-pane fade in">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-icon">
                        <ul class="btn-tasks">
                            <li class="dropdown"><a href="#" id="pdf2" class="tip" title="<?= lang('download_pdf') ?>"><i class="icon fa fa-file-pdf-o"></i></a></li>
                            <li class="dropdown"><a href="#" id="xls2" class="tip" title="<?= lang('download_xls') ?>"><i class="icon fa fa-file-excel-o"></i></a></li>
                            <li class="dropdown"><a href="#" id="image2" class="tip image" title="<?= lang('save_image') ?>"><i class="icon fa fa-file-picture-o"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-content">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div id="form">
                                ...
                                <div class="form-group">
                                    <div class="controls"> <?= form_submit('submit_sale_report', lang('submit'), 'class="btn btn-primary"'); ?> </div>
                                </div>
                                <?= form_close(); ?>
        ...
        <div id="purchases-con" class="tab-pane fade in">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-icon">
                        <ul class="btn-tasks">
                            <li class="dropdown"><a href="#" id="pdf3" class="tip" title="<?= lang('download_pdf') ?>"><i class="icon fa fa-file-pdf-o"></i></a></li>
                            <li class="dropdown"><a href="#" id="xls3" class="tip" title="<?= lang('download_xls') ?>"><i class="icon fa fa-file-excel-o"></i></a></li>
                            <li class="dropdown"><a href="#" id="image3" class="tip image" title="<?= lang('save_image') ?>"><i class="icon fa fa-file-picture-o"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-content">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div id="pform">
                                ...
                                <div class="form-group">
                                    <div class="controls"> <?= form_submit('submit_purchase_report', lang('submit'), 'class="btn btn-primary"'); ?> </div>
                                </div>
                                <?= form_close(); ?>
                            ...
                            <div class="table-responsive">
                                <table id="PoRData" class="table table-bordered table-hover table-striped table-condensed reports-table">
                                    <thead>
                                        <tr>
                                            <th><?= lang('date'); ?></th>
                                            <th><?= lang('reference_no'); ?></th>
        ...
        <div id="payments-con" class="tab-pane fade in">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-icon">
                        <ul class="btn-tasks">
                            <li class="dropdown"><a href="#" id="pdf4" class="tip" title="<?= lang('download_pdf') ?>"><i class="icon fa fa-file-pdf-o"></i></a></li>
                            <li class="dropdown"><a href="#" id="xls4" class="tip" title="<?= lang('download_xls') ?>"><i class="icon fa fa-file-excel-o"></i></a></li>
                            <li class="dropdown"><a href="#" id="image4" class="tip image" title="<?= lang('save_image') ?>"><i class="icon fa fa-file-picture-o"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-content">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div id="payform">
                                ...
                                <div class="form-group">
                                    <div class="controls"> <?= form_submit('submit_payment_report', lang('submit'), 'class="btn btn-primary"'); ?> </div>
                                </div>
                                <?= form_close(); ?>
            ...
            <div class="box-header">
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        ...
                        <li class="dropdown"><a href="#" class="logintoggle_down tip" title="<?= lang('hide_form') ?>"><i class="icon fa fa-toggle-down"></i></a>
                        </li>
                    </ul>
                </div>
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown"><a href="#" id="pdf5" class="tip" title="<?= lang('download_pdf') ?>"><i class="icon fa fa-file-pdf-o"></i></a></li>
                        <li class="dropdown"><a href="#" id="xls5" class="tip" title="<?= lang('download_xls') ?>"><i class="icon fa fa-file-excel-o"></i></a></li>
                        <li class="dropdown"><a href="#" id="image5" class="tip image" title="<?= lang('save_image') ?>"><i class="icon fa fa-file-picture-o"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="loginform">
                            ...
                            <div class="form-group">
                                <div class="controls"> <?= form_submit('submit_login_report', lang('submit'), 'class="btn btn-primary"'); ?> </div>
                            </div>
                            <?= form_close(); ?>
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table id="LGTable" class="table table-bordered table-hover table-striped reports-table">
                                            <thead>
                                                <tr>
                                                    <th><?= lang('email'); ?></th>
