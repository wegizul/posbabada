                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <span class="help-block"><?= lang('download') . ': <a href="https://tecdiary.net/products/php-pos-print-server-windows-installer" target="_blank">PHP Pos Print Server</a>'; ?></span>
                            <?php if (DEMO) {
                                ?>
