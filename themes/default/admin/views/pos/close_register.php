...
<div class="modal fade" id="empModal">
    <div class="modal-dialog modal-lg" style="height:max-content;">
        <div class="modal-content">
            <div class="modal-header">
                <a href="<?= base_url('admin/pos') ?>" type="button" class="close" aria-hidden="true"><i class="fa fa-2x">&times;</i>
                </a>
            ...
            <div class="modal-body">
                ...
                <div class="form-group no-print">
                    ...
                    <div class="controls"> <?= form_textarea('note', ($_POST['note'] ?? ''), 'class="form-control" id="note" style="margin-top: 10px; height: 100px;"'); ?> </div>
                </div>
